...
exports.queryPlannerNode = queryPlannerNode;
const query_plan_1 = require("../types/query-plan");
 ...
 */
async function queryPlannerNode(state) {
...
`;
        ...
        const validationResult = query_plan_1.QueryPlanSchema.safeParse(parsedPlan);
        ...
        const queryPlan = validationResult.data;
