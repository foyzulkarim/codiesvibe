...
exports.weightedSumFusion = weightedSumFusion;
exports.concatFusion = concatFusion;
exports.fuseResults = fuseResults;
exports.groupCandidatesBySource = groupCandidatesBySource;
 ...
 */
function reciprocalRankFusion(candidatesBySource, k = 60) {
 ...
 */
function weightedSumFusion(candidatesBySource, sourceWeights = new Map()) {
 ...
 */
function concatFusion(candidatesBySource) {
 ...
 */
function fuseResults(candidatesBySource, method, sourceWeights) {
