...
describe('DTO Validation', () => {
  describe('CreateToolEnhancedDto', () => {
    it('should validate valid complete tool successfully', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.validCompleteTool);
    ...
    it('should validate valid minimal tool successfully', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.validMinimalTool);
      const errors = await validate(dto);
    ...
    it('should reject tool with missing name', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.missingName);
      const errors = await validate(dto);
    ...
    it('should reject tool with missing description', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.missingDescription);
      const errors = await validate(dto);
    ...
    it('should reject tool with empty pricing array', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.emptyPricing);
      const errors = await validate(dto);
    ...
    it('should reject tool with empty interface array', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.emptyInterface);
      const errors = await validate(dto);
    ...
    it('should reject tool with empty functionality array', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.emptyFunctionality);
      const errors = await validate(dto);
      
      expect(errors.length).toBeGreaterThan(0);
      expect(errors.some(error => error.property === 'functionality')).toBe(true);
    });

    it('should reject tool with negative popularity', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.negativePopularity);
      const errors = await validate(dto);
    ...
    it('should reject tool with popularity too high', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.popularityTooHigh);
      const errors = await validate(dto);
    ...
    it('should reject tool with rating too high', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.ratingTooHigh);
      const errors = await validate(dto);
    ...
    it('should reject tool with invalid logo URL', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.invalidLogoUrl);
      const errors = await validate(dto);
    ...
    it('should reject tool with invalid features values', async () => {
      const dto = plainToInstance(CreateToolEnhancedDto, VALIDATION_FIXTURES.invalidData.invalidFeaturesValues);
      const errors = await validate(dto);
    ...
    it('should reject tool with description exceeding max length', async () => {
      ...
      const dto = plainToInstance(CreateToolEnhancedDto, toolWithLongDescription);
      const errors = await validate(dto);
    ...
    it('should validate nested object properties', async () => {
      ...
      const dto = plainToInstance(CreateToolEnhancedDto, toolWithInvalidFeatures);
      const errors = await validate(dto);
